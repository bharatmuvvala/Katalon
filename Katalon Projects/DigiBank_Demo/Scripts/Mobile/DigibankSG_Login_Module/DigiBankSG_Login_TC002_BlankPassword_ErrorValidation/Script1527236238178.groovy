...
Mobile.setText(findTestObject('Mobile/DigiBankSG_Login_OR/LoginPage_txtedit_PIN'), 'Please enter your PIN.', 0)

Mobile.tap(findTestObject('Mobile/DigiBankSG_Login_OR/LoginPage_button_Login'), 0)

Mobile.verifyElementHasAttribute(findTestObject('Mobile/DigiBankSG_Login_OR/LoginPage_txtview_InvalidLoginDetails'), 'Sorry, you have entered an invalid User ID. Please try again.', 
    0)
