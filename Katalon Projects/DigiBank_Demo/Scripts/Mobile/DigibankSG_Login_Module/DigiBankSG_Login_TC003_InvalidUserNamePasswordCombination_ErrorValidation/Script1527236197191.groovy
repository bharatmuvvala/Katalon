...
Mobile.setText(findTestObject('Mobile/DigiBankSG_Login_OR/LoginPage_txtedit_UserID'), 'testuser', 0)
...
Mobile.verifyElementHasAttribute(findTestObject('Mobile/DigiBankSG_Login_OR/LoginPage_txtview_InvalidLoginDetails'), 'You may have keyed in an invalid User ID or PIN. Please try again.', 
    0)
